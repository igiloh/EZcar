...
parser.add_argument('--lanes', action='store', dest='lanes', default='FORWARD,FORWARD',
                    help='lanes (default: FORWARD,FORWARD) - left is rightmost lane. Lane can be either '
...
d = EZdriver.Driver(arguments.stage, arguments.lanes, arguments.seed , arguments.lane)
